...
public class Jiemian{
	...
	ImageIcon i = new ImageIcon("c:\\ANNIU.png");
	ImageIcon i2 = new ImageIcon("c:\\ANNIU2.png");
    CardLayout cl;
    //主界面按钮定义
    ...
    //角色选择按钮定义
    JButton juese1,juese2,juese3,kai;
    Jue1 jue1 = new Jue1();
    Jue2 jue2 = new Jue2();
    Jue3 jue3 = new Jue3();
    //背景音乐定义
    ...
    AudioClip music;*/
    public Jiemian(int n) {
    	youxi.setTitle("Card Game");
		youxi.setSize(1200,800);
		youxi.setVisible(true);
		youxi.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	class Jue1 extends JPanel{
		ImageIcon ij1 = new ImageIcon("c:\\JUE1.png");
	...
	class Jue2 extends JPanel{
		ImageIcon ij2 = new ImageIcon("c:\\JUE2.png");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
	...
	class Jue3 extends JPanel{
		ImageIcon ij3 = new ImageIcon("c:\\JUE3.png");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
	...
	class Charu1 extends JPanel{
		ImageIcon i3 = new ImageIcon("c:\\BEIJING1.jpg");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
	...
	class Charu2 extends JPanel{
		ImageIcon i4 = new ImageIcon("c:\\BEIJING2.png");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
	...
	class Charu3 extends JPanel{
		ImageIcon i5 = new ImageIcon("c:\\BEIJING3.jpg");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
			//下面这行是为了背景图片可以跟随窗口自行调整大小，可以自己设置成固定大小
	...
	class Charu4 extends JPanel{
		ImageIcon i6 = new ImageIcon("c:\\BEIJING4.jpg");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
			//下面这行是为了背景图片可以跟随窗口自行调整大小，可以自己设置成固定大小
	...
	class Charu5 extends JPanel{
		ImageIcon i7 = new ImageIcon("c:\\BEIJING5.jpg");
		public void paintComponent(Graphics g) {
			super.paintComponent(g);
			//下面这行是为了背景图片可以跟随窗口自行调整大小，可以自己设置成固定大小
